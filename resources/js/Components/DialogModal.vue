...
<template>
    <Modal
        ...
        @close="close"
    >
        <div v-if="variant === 'default'" class="px-6 py-4">
        ...
        <div v-else-if="variant === 'danger'" class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <div class="flex flex-col sm:flex-row justify-end gap-3 px-4 sm:px-6 py-4 bg-gray-100">
            <slot name="footer" />
        </div>
    </Modal>
</template>
