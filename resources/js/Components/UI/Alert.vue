<template>
    <div
        v-if="show"
        :class="alertClasses"
        class="p-4 rounded-lg shadow-sm border flex items-start gap-3 transition-all duration-300"
        role="alert"
    >
        ...
        <button
            v-if="dismissible"
            @click="dismiss"
            class="flex-shrink-0 rounded-lg p-1.5 inline-flex items-center justify-center hover:bg-black/5 transition-colors"
            aria-label="Fermer"
        >
