<template>
    <AppLayout title="Recettes anti-gaspi">
        <template #header>
            <div class="flex justify-between items-center">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                    Que cuisiner avec mes ingrédients ? 🌱
                </h2>
            </div>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-[1920px] mx-auto sm:px-6 lg:px-8">
                <div v-if="loading" class="text-center py-12">
                    ...
                    <p class="mt-4 text-gray-600">Recherche de recettes...</p>
                </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-600 mt-1">
                                    Basé sur {{ pantryIngredientsCount }} ingrédient{{ pantryIngredientsCount > 1 ? 's' : '' }} dans votre garde-manger
                                </p>
                            </div>
                            <div class="flex items-center gap-4">
                                <label class="flex items-center">
                                    ...
                                    >
                                    <span class="ml-2 text-sm text-gray-700">Recettes réalisables entièrement</span>
                                </label>
                            </div>
                        </div>
                    </div>
                        ...
                        >
                            ...
                            <div class="p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="text-xs text-gray-600 space-y-1">
                                        <div class="flex items-center gap-1">
                                            ...
                                            <span>{{ recipe.matching_ingredients_count }} ingrédient{{ recipe.matching_ingredients_count > 1 ? 's' : '' }} que vous avez</span>
                                        </div>
                                        <div v-if="recipe.missing_ingredients_count > 0" class="flex items-center gap-1">
                                            ...
                                            <span>{{ recipe.missing_ingredients_count }} manquant{{ recipe.missing_ingredients_count > 1 ? 's' : '' }}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div v-if="recipe.can_make_with_pantry" class="mt-3 flex items-center gap-2 text-green-600 text-sm font-medium">
                                    ...
                                    <span>Réalisable maintenant!</span>
                                </div>
                            </div>
                        </div>
                    </div>
