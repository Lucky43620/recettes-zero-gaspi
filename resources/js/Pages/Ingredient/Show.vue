                ...
                <div class="bg-white overflow-hidden shadow-2xl sm:rounded-2xl border border-gray-100">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 p-8">
                        ...
                        <div class="lg:col-span-1 space-y-4">
                            <div v-if="ingredient.image_url" class="aspect-square rounded-xl overflow-hidden bg-gray-100 shadow-lg ring-1 ring-gray-200">
                                <img :src="ingredient.image_url" :alt="ingredient.name" class="w-full h-full object-cover">
                            </div>
                            <div v-else class="aspect-square rounded-xl bg-gradient-to-br from-green-100 via-emerald-100 to-green-200 flex items-center justify-center shadow-lg ring-1 ring-green-200">
                                <svg class="w-32 h-32 text-green-600 opacity-50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                                </svg>
                            </div>

                            <div v-if="ingredient.barcode" class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5 shadow-sm border border-gray-200">
                                <div class="flex items-center gap-2 mb-2">
                                    ...
                                    <p class="text-sm font-semibold text-gray-700">Code-barres</p>
                                </div>
                                <p class="font-mono text-lg text-gray-900 tracking-wider">{{ ingredient.barcode }}</p>
                            </div>

                            <div v-if="ingredient.openfoodfacts_id" class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl p-5 shadow-sm border border-blue-200">
                                <div class="flex items-start gap-3">
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm text-blue-900 font-semibold mb-1">Données OpenFoodFacts</p>
                        ...
                        <div class="lg:col-span-2">
                            ...
                            <div v-if="ingredient.category" class="mb-6">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <span
                                        ...
                                        :key="cat"
                                        class="px-3 py-1.5 bg-gradient-to-r from-green-100 to-emerald-100 text-green-800 rounded-lg text-sm font-medium shadow-sm border border-green-200"
                                    >
                                        {{ cat.trim() }}
                                    </span>
                                </div>
                            ...
                            <div v-if="ingredient.labels && ingredient.labels.length > 0" class="mb-6">
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <span
                                        ...
                                        :key="label"
                                        class="px-3 py-1.5 bg-gradient-to-r from-blue-100 to-indigo-100 text-blue-800 rounded-lg text-sm font-medium inline-flex items-center gap-1.5 shadow-sm border border-blue-200"
                                    >
                            ...
                            <div v-if="ingredient.allergens && ingredient.allergens.length > 0" class="mb-6">
                                ...
                                <div class="bg-gradient-to-br from-red-50 to-orange-50 border border-red-300 rounded-xl p-5 shadow-sm">
                                    <div class="flex flex-wrap gap-2">
                                        <span
                                            v-for="allergen in ingredient.allergens"
                                            :key="allergen"
                                            class="px-3 py-1.5 bg-red-100 text-red-900 rounded-lg text-sm font-semibold inline-flex items-center gap-1.5 shadow-sm border border-red-300"
                                        >
                                            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div v-if="ingredient.nutritional_info && hasNutritionalData" class="mb-8">
                                ...
                                <p class="text-sm text-gray-500 mb-4 ml-7">Pour 100g</p>
